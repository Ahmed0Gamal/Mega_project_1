...
{
	GPIO_vSetOutputPinValue(CLCD_u8_CTRL_PORT,CLCD_u8_E_PIN,OUTPUT_HIGH);
	STK_vSetBusyWait(3);
	GPIO_vSetOutputPinValue(CLCD_u8_CTRL_PORT,CLCD_u8_E_PIN,OUTPUT_LOW);
}


static void SetHalfDataPins(uint8_t Copy_u8Data)
{
	GPIO_vSetOutputPinValue(CLCD_u8_DATA_PORT,CLCD_u8_PIN4,GET_BIT(Copy_u8Data,0));
	GPIO_vSetOutputPinValue(CLCD_u8_DATA_PORT,CLCD_u8_PIN5,GET_BIT(Copy_u8Data,1));
	GPIO_vSetOutputPinValue(CLCD_u8_DATA_PORT,CLCD_u8_PIN6,GET_BIT(Copy_u8Data,2));
	GPIO_vSetOutputPinValue(CLCD_u8_DATA_PORT,CLCD_u8_PIN7,GET_BIT(Copy_u8Data,3));
	SendEnablePulse();
...
void CLCD_voidSendCommand(uint8_t Copy_u8Command)
{
	...
	GPIO_vSetOutputPinValue(CLCD_u8_CTRL_PORT,CLCD_u8_RS_PIN,OUTPUT_LOW);

	//Set RW pin to low to write
	GPIO_vSetOutputPinValue(CLCD_u8_CTRL_PORT,CLCD_u8_RW_PIN,OUTPUT_LOW);
...
void CLCD_voidSendData(uint8_t Copy_u8Data)
{
	...
	GPIO_vSetOutputPinValue(CLCD_u8_CTRL_PORT,CLCD_u8_RS_PIN,OUTPUT_HIGH);
